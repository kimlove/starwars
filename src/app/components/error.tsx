export const Error = () => (
  <div className="grid place-content-center justify-center h-96 bg-black/70 rounded-xl backdrop-blur-lg gap-2 fade-in">
    <div className="mx-auto mb-4 size-24 text-red-400 animate-pulse">
      <svg
    ...
    <p className="text-red-400 tracking-widest text-lg">
      Hmmm… data not found, it is. Try once more, you must.
    </p>
    <div className="mt-2 flex justify-center">
      <button
        onClick={() => window.location.reload()}
        className="mt-4 px-6 py-2 bg-red-800 font-bold text-white rounded-full hover:bg-red-700 transition duration-200"
      >
        Reload Page
      </button>
    </div>
